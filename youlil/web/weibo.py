...
class HttpObject(object):
    ...
    def __getattr__(self, attr):
        ...
        return wrap
    def __getstate__(self):
        return self.client,self.method
    def __setstate__(self,state):
        self.client,self.method=state
...
class APIClient(object):
    ...
    def __getstate__(self):
        return self.client_id,self.redirect_uri,self.response_type,self.auth_url,self.api_url,self.access_token,self.expires,self.get,self.post,self.upload
    
    def __setstate__(self,state):
        self.client_id,self.redirect_uri,self.response_type,self.auth_url,self.api_url,self.access_token,self.expires,self.get,self.post,self.upload=state